...
This document defines the standards for all research activities including data collection, API usage, analysis methodology, and reporting requirements. All research tasks must follow these protocols to ensure reproducibility and quality.
